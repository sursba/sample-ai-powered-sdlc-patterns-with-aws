...
public class DocumentationController {
    ...
    public String requirements(Model model) {
        ...
        Map<String, String> useCase1 = new HashMap<>();
        ...
        Map<String, String> useCase2 = new HashMap<>();
        ...
        Map<String, String> useCase3 = new HashMap<>();
        ...
        Map<String, String> useCase4 = new HashMap<>();
        ...
        Map<String, String> useCase5 = new HashMap<>();
        ...
        List<Map<String, String>> functionalRequirements = new ArrayList<>();
        ...
        List<Map<String, String>> nonFunctionalRequirements = new ArrayList<>();
        
        Map<String, String> nfr1 = new HashMap<>();
        nfr1.put("id", "NFR-1");
        ...
        Map<String, String> nfr2 = new HashMap<>();
        nfr2.put("id", "NFR-2");
        ...
        Map<String, String> nfr3 = new HashMap<>();
        nfr3.put("id", "NFR-3");
        ...
        Map<String, String> nfr4 = new HashMap<>();
        nfr4.put("id", "NFR-4");
    ...
    public String systemBehavior(Model model) {
        ...
        Map<String, String> comp5 = new HashMap<>();
        ...
        Map<String, String> int1 = new HashMap<>();
        ...
        Map<String, String> int2 = new HashMap<>();
        ...
        Map<String, String> int3 = new HashMap<>();
