...
Ready to see Jenkins MCP Server in action? Check out our demo materials:

### 🎯 Quick Demo
```bash
# Check if demo environment is ready
./demo/check_demo_ready.sh

# Follow demo setup guide
cat demo/DEMO_SETUP.md

# Run the demo
# See demo/DEMO_SCRIPT.md for complete flow
```

### 📁 Demo Materials
- **[demo/DEMO_SCRIPT.md](demo/DEMO_SCRIPT.md)** - Complete 10-15 minute demo script
- **[demo/DEMO_SETUP.md](demo/DEMO_SETUP.md)** - Quick setup guide for demo environment  
- **[demo/DEMO_PROMPTS.md](demo/DEMO_PROMPTS.md)** - All demo prompts with alternatives
- **[demo/README.md](demo/README.md)** - Demo materials overview

### 🚀 Demo Highlights
- Natural language Jenkins operations
